...
**Direct Link:** [Install from VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=pankajghosh.nexus-dark)
...
1. Download the `.vsix` file from the [Releases](https://github.com/iampankajghosh/nexus-dark/releases) page
2. Open VS Code
...
- **[vscode-styled-components](https://marketplace.visualstudio.com/items?itemName=styled-components.vscode-styled-components)** – Improved highlighting for styled-components
- **[ES7+ React/Redux/React-Native snippets](https://marketplace.visualstudio.com/items?itemName=dsznajder.es7-react-js-snippets)** – Enhanced React & JSX support
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/iampankajghosh/nexus-dark/issues).
...
- GitHub: [@iampankajghosh](https://github.com/iampankajghosh)
- VS Code Marketplace: [pankajghosh](https://marketplace.visualstudio.com/publishers/pankajghosh)
